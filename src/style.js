export const section = {
    ...
    textPaddingY: 'py-2',
    heading: 'text-deep-blue font-poppins text-4xl leading-tight sm:text-7xl font-bold dark:text-gray relative',
    textLgDefault : 'text-deep-gray font-bold font-quicksand',
    textLarge: 'text-2xl sm:text-3xl',
    textSmall: 'text-lg sm:text-xl',
    text: 'text-deep-green font-poppins text-center text-base sm:text-lg',
