      ...
      <div className={`${section.layout}`}>
        {
          Projects.map((project) => (
            <div key={project.id}>
              ...
              <div>
                <p className={`${section.textSmall} ${section.textLgDefault} ${section.textPaddingY}`}>{project.work}</p>
                <p className={`text-sm sm:text-lg ${section.textLgDefault}`}>{project.name}</p>
                <p></p>
              </div>
            </div>
          ))
